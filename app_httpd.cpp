...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "<p align=center><IMG SRC='http://" + Camerafeed + ":81/stream' style='width:500px; transform:rotate(180deg);'></p><br/><br/>";
 
 page += "<p align=center> <button style=width:90px;height:30px; onmousedown=getsend('forward')  ontouchstart=getsend('forward')  >Forward</button> </p>";
 page += "<p align=center>";
 page += "<button style=width:90px;height:30px onmousedown=getsend('leftturn')  ontouchstart=getsend('leftturn') >Left</button>&nbsp;";
 page += "<button style=width:90px;height:30px onmousedown=getsend('stop') onmouseup=getsend('stop')>Stop</button>&nbsp;";
 page += "<button style=width:90px;height:30px onmousedown=getsend('rightturn')  ontouchstart=getsend('rightturn') >Right</button>";
 page += "</p>";

 page += "<p align=center><button style=width:90px;height:30px onmousedown=getsend('reverse')  ontouchstart=getsend('reverse')  >Reverse</button></p>";  
